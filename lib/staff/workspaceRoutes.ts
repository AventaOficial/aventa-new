...
export const WORKSPACE_HUB_ROUTES = [
  ...
  '/equipo/contabilidad',
  '/equipo/contabilidad/centro-pagos',
...
export const WORKSPACE_STAFF_API_ROUTES = [
  ...
  '/api/staff/finance/payout-ops',
  '/api/staff/finance/payout-ops/batches',
  '/api/staff/finance/payout-ops/evidence/amazon',
  '/api/staff/finance/payout-ops/export',
