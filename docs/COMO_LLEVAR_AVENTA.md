...
## 4. Prompt maestro (ahorrar tokens)

Para no repetir contexto en cada chat nuevo: en **docs/PROMPT_MAESTRO.md** hay un bloque corto que copias y pegas al abrir la conversación. Incluye quién eres, qué es AVENTA, stack y dónde está la guía y los pendientes. Así la IA entiende el proyecto en una sola pasada y gastas menos tokens.
