...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-007-USER-B-E2 |
| USER | USER-B - Usuario casual |
| TASK | TASK-007 - Guardar/favoritar |
| ENTRY | `/` (salvo gates) |
...
- Home ATTENTION-1: image
- Home ATTENTION-2: discount_badge
...
- USER INTERPRETATION: Usuario casual: interpreta Home como punto de partida para ofertas.
- ACTION: Orientarse
...
### Step 2 - DISCOVERY
- SCREEN: /
- VISIBLE INFORMATION: Cards OfferCard; tabs; ATTENTION-1=image; ATTENTION-2=discount_badge; ATTENTION-3(posible ignore)=comments
- USER INTERPRETATION: Cree que puede scrollear/filtrar/abrir cards. Prioriza: image, discount_badge, title. Puede ignorar: comments, report, share_menu.
- ACTION: Scroll + inspeccionar cards
- INTERACTION TYPE: INT-SCROLL
- DECISION: Usar modo vitales|latest
- REASON: Perfil USER-B
- UNCERTAINTY: MEDIUM
...
### Step 4 - ACTION
- SCREEN: /
- VISIBLE INFORMATION: Heart en OfferCard
- USER INTERPRETATION: Cree que puede guardar; anon en card → redirect home.
- ACTION: Tap heart
- INTERACTION TYPE: INT-FAV
- DECISION: Favoritar
- REASON: Guardar para despues
- UNCERTAINTY: HIGH post-error
- SYSTEM RESPONSE: router.push("/") (OfferCard)
- NEXT STEP: home
- ERROR: SIM-ERR-2
- RECOVERY: FAILED hacia home; intencion favorito interrumpida
...
- INT-004: TYPE=FAV; TARGET=OfferCard heart; PURPOSE=ACTION; RESULT=Auth wall

## Decisions log
- DEC-D1: OPTIONS=[vitales, top, latest, personalized?, categoria]; CHOSEN=vitales|latest; REASON=Sesgo USER-B; CONFIDENCE=MEDIUM
- DEC-06: OPTIONS=[ignorar, abrir, votar en card, fav en card]; CHOSEN=abrir; REASON=Imagen atractiva; CONFIDENCE=MEDIUM

## Potential abandonment
- POTENTIAL ABANDONMENT: step~4; motive=Auth wall disruptivo en favorito; severity=HIGH; evidence=E2

## Friction hypotheses (E2)
- Favorito anon en card redirige a / - posible perdida de contexto
