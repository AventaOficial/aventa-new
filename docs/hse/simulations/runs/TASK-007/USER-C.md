...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-007-USER-C-E2 |
...
### Step 4 - ACTION
- SCREEN: /oferta/[id] o card
- VISIBLE INFORMATION: Heart control
- USER INTERPRETATION: Toggle favorito con feedback de estado.
- ACTION: Toggle fav
- INTERACTION TYPE: INT-FAV
- DECISION: Guardar
- REASON: Revisitar despues
- UNCERTAINTY: LOW
- SYSTEM RESPONSE: applyFavoriteToggle → offer_favorites
- NEXT STEP: SUCCESS
- ERROR: SIM-ERR-0
- RECOVERY: n/a
...
- INT-004: TYPE=FAV; TARGET=Heart; PURPOSE=ACTION; RESULT=Favorite saved
