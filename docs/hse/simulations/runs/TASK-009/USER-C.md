...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-009-USER-C-E2 |
...
### Step 4 - ACTION
- SCREEN: /oferta/[id]
- VISIBLE INFORMATION: Comment composer
- USER INTERPRETATION: Puede publicar comentario con Bearer.
- ACTION: Escribir + submit
- INTERACTION TYPE: INT-INPUT + INT-SUBMIT
- DECISION: Publicar comentario
- REASON: Aportar experiencia
- UNCERTAINTY: LOW
- SYSTEM RESPONSE: POST /api/offers/[id]/comments
- NEXT STEP: SUCCESS
- ERROR: SIM-ERR-0
- RECOVERY: n/a
...
- INT-004: TYPE=INPUT; TARGET=Comment; PURPOSE=ACTION; RESULT=Text entered
- INT-005: TYPE=SUBMIT; TARGET=Comment; PURPOSE=ACTION; RESULT=Comment posted
