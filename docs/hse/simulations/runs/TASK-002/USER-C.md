...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-002-USER-C-E2 |
| USER | USER-C - Cazador experto |
| TASK | TASK-002 - Encontrar oferta en categoria |
| ENTRY | `/` (salvo gates) |
...
- ACTION: Aplicar categoria
- INTERACTION TYPE: INT-FILTER
...
- INT-002: TYPE=FILTER; TARGET=Home feed; PURPOSE=DISCOVERY; RESULT=Candidates visible
- INT-003: TYPE=CLICK; TARGET=OfferCard; PURPOSE=OPEN_DETAIL; RESULT=Navigate /oferta/[id]

## Decisions log
- DEC-D1: OPTIONS=[vitales, top, latest, personalized?, categoria]; CHOSEN=vitales chips categoria o /categoria/[slug]; REASON=Sesgo USER-C; CONFIDENCE=MEDIUM
