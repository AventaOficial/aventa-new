...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-002-USER-H-E2 |
...
## Decisions log
- DEC-D1: OPTIONS=[vitales, top, latest, personalized?, categoria]; CHOSEN=vitales chips categoria o /categoria/[slug]; REASON=Sesgo USER-H; CONFIDENCE=MEDIUM
