...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-008-USER-B-E2 |
...
### Step 4 - ACTION
- SCREEN: /
- VISIBLE INFORMATION: Vote arrows en card
- USER INTERPRETATION: Intenta votar; recibe toast login.
- ACTION: Vote up
- INTERACTION TYPE: INT-VOTE
- DECISION: Votar
- REASON: Participar
- UNCERTAINTY: MEDIUM
- SYSTEM RESPONSE: Toast inicia sesion (OfferCard)
- NEXT STEP: auth or abandon
- ERROR: SIM-ERR-1
- RECOVERY: PARTIALLY_RECOVERED si autentica
...
- INT-004: TYPE=VOTE; TARGET=VoteUp; PURPOSE=ACTION; RESULT=Auth toast
...
- POTENTIAL ABANDONMENT: step~4; motive=Bajo compromiso + auth wall; severity=HIGH; evidence=E2
