...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-001-USER-C-E2 |
| USER | USER-C - Cazador experto |
| TASK | TASK-001 - Encontrar una oferta interesante |
| ENTRY | `/` (salvo gates) |
...
### Step 4 - OUTCOME
- SCREEN: /oferta/[id] or still on card
- VISIBLE INFORMATION: Candidato identificado
- USER INTERPRETATION: Tarea 001 satisfecha al fijar atencion / abrir
- ACTION: Stop discovery primary
- INTERACTION TYPE: -
- DECISION: Oferta interesante seleccionada
- REASON: Criterio catalogo (proxy open)
- UNCERTAINTY: MEDIUM - "interesante" es subjetivo
- SYSTEM RESPONSE: Detail loaded if opened
- NEXT STEP: end
- ERROR: SIM-ERR-0
- RECOVERY: n/a
