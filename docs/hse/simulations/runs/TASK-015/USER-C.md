...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-015-USER-C-E2 |
| USER | USER-C - Cazador experto |
| TASK | TASK-015 - Uso desktop |
| ENTRY | `/` (salvo gates) |
...
- VISIBLE INFORMATION: ActionBar segun viewport (UNKNOWN exacto en simulacion abstracta); Rail tiendas solo xl
- USER INTERPRETATION: Sidebar con Plaza; search sticky; rail xl posible.
- ACTION: Usar sidebar / search
- INTERACTION TYPE: INT-CLICK
- DECISION: Permanecer en Home feed
- REASON: Desktop shell baseline
- UNCERTAINTY: LOW
- SYSTEM RESPONSE: Layout md:flex sidebar
- NEXT STEP: discovery
- ERROR: SIM-ERR-0
- RECOVERY: n/a
...
- INT-002: TYPE=CLICK; TARGET=Sidebar Inicio; PURPOSE=DEVICE; RESULT=Stay home
