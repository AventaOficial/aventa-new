...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-015-USER-G-E2 |
...
- VISIBLE INFORMATION: ActionBar tabbar (Inicio, Guia, Subir, Favoritos, Perfil) - Plaza no visible; HomeDesktopRail no visible
...
- POTENTIAL ABANDONMENT: step~3; motive=Overload de cards/tabs sin modelo mental (hipotesis); severity=MEDIUM; evidence=E2
