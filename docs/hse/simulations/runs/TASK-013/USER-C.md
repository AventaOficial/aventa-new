...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-013-USER-C-E2 |
| USER | USER-C - Cazador experto |
| TASK | TASK-013 - Uso recurrente |
| ENTRY | `/` (salvo gates) |
...
### Step 4 - SESSION
- SCREEN: /
- VISIBLE INFORMATION: Tab Para ti disponible
- USER INTERPRETATION: Habitos: ir a modo conocido → accion rapida.
- ACTION: Abrir Para ti → card → outbound o fav
- INTERACTION TYPE: INT-SELECT + INT-CLICK
- DECISION: Atajo habitual
- REASON: Modelo recurrente
- UNCERTAINTY: LOW
- SYSTEM RESPONSE: for-you API si auth
- NEXT STEP: mini outcome
- ERROR: SIM-ERR-0
- RECOVERY: n/a
...
- INT-004: TYPE=SELECT; TARGET=Tab; PURPOSE=RECURRING; RESULT=Mode chosen
- INT-005: TYPE=CLICK; TARGET=Card; PURPOSE=RECURRING; RESULT=Open
