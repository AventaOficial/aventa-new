...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-003-USER-J-E2 |
...
### Step 4 - EVALUATION
- SCREEN: /oferta/[id]
- VISIBLE INFORMATION: Precio, descuento, tienda, votos, texto. ATTENTION: precio/descuento, CTA outbound; posible ignore affiliate disclosure / condiciones (posible ignore)
...
- DEC-09: OPTIONS=[vale, no vale, inseguro]; CHOSEN=vale (rapido); REASON=Simulacion cualitativa; CONFIDENCE=LOW
