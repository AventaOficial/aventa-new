...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-003-USER-C-E2 |
...
- TRUST QUESTIONS: El descuento es creible? | La tienda es conocida? | Los votos bastan como prueba? | Hay TRUST PROOF o solo SIGNAL?
...
### Step 4 - EVALUATION
- SCREEN: /oferta/[id]
- VISIBLE INFORMATION: Precio, descuento, tienda, votos, texto. ATTENTION: precio/descuento, tienda/votos; posible ignore affiliate disclosure / condiciones (posible ignore)
- USER INTERPRETATION: Forma juicio vale/no vale/inseguro (no persistido en sistema).
- ACTION: Leer senales
- INTERACTION TYPE: INT-SCROLL
- DECISION: Evaluar por credibilidad+precio
- REASON: Sesgo USER-C
- UNCERTAINTY: MEDIUM
