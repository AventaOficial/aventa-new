...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-012-USER-C-E2 |
...
### Step 4 - DISCOVERY
- SCREEN: /me/favorites
- VISIBLE INFORMATION:  /me/favorites
...
- UNCERTAINTY: HIGH
- SYSTEM RESPONSE: middleware+favorites query
...
- INT-004: TYPE=NAV; TARGET= /me/favorites; PURPOSE=REENCUENTRO; RESULT=Attempt locate
