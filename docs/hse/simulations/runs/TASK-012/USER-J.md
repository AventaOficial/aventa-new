...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-012-USER-J-E2 |
...
### Step 4 - DISCOVERY
- SCREEN: /me/favorites
- VISIBLE INFORMATION: URL directa si la recuerda; else favorites
- USER INTERPRETATION: No hay historial dedicado en baseline - usa favoritos o scroll.
- ACTION: URL directa si la recuerda; else favorites
...
- INT-004: TYPE=NAV; TARGET=URL directa si la recuerda; else favorites; PURPOSE=REENCUENTRO; RESULT=Attempt locate
