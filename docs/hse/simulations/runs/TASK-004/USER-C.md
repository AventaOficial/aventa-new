...
| Campo | Valor |
|---|---|
| SIMULATION-ID | SIM-TASK-004-USER-C-E2 |
| USER | USER-C - Cazador experto |
| TASK | TASK-004 - Abrir detalles |
| ENTRY | `/` (salvo gates) |
...
### Step 4 - OUTCOME
- SCREEN: /oferta/[id]
- VISIBLE INFORMATION: OfferPageContent detalle
- USER INTERPRETATION: Detalle cargado = exito de abrir
- ACTION: Confirmar contenido visible
- INTERACTION TYPE: INT-NAV
- DECISION: Permanecer en detalle
- REASON: Objetivo TASK-004
- UNCERTAINTY: LOW
- SYSTEM RESPONSE: Server approved+not expired else notFound
- NEXT STEP: end
- ERROR: SIM-ERR-0
- RECOVERY: n/a
