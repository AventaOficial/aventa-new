    ...
    steps: [
      ...
      },
      {
        ...
        body: [
          ...
          'Últimas — lo más reciente, sin filtros de ranking.',
        ],
      ...
      },
      {
        ...
        subtitle: 'Pulgar arriba o abajo',
        illustration: 'vote',
        body: [
          'Pulgar arriba si el precio y la oferta son buenos. Pulgar abajo si crees que puede mejorar o no convence.',
    ...
    steps: [
      ...
      },
      {
        ...
        body: [
          ...
          'Últimas — recién publicado, ideal para cazar antes que se acabe.',
        ],
      ...
      },
      {
        ...
        body: [
          'Aunque no subas ofertas, tu pulgar arriba o abajo ordena el feed para todos.',
