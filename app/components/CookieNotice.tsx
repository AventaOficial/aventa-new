...
export default function CookieNotice() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(5rem+env(safe-area-inset-bottom))] md:bottom-4 z-40 px-3">
      <div className="mx-auto max-w-3xl rounded-xl border border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-[#141414]/95 backdrop-blur px-3 py-2.5 shadow-lg">
