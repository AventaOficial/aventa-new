...
export default function ContextoContent() {
  return (
    <div className="space-y-8 pb-10 max-w-3xl">
      <header>
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-gray-100">Contexto del sistema</h1>
      ...
      <div className="space-y-8">
        {OWNER_CONTEXT_SECTIONS.map((section) => (
          <section
            key={section.id}
            className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1C1C1E] overflow-hidden shadow-sm"
          >
