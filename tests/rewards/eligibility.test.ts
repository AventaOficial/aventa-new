...
describe('Rewards eligibility (15 approved + 15 distinct voters)', () => {
  it('14 ofertas + 15 distinct = no elegible', () => {
  ...
  it('15 ofertas + 14 distinct = no elegible', () => {
  ...
  it('15 ofertas + 15 distinct = elegible (volumen)', () => {
