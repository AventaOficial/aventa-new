    ...
    const merged = mergeMercadoLibrePublicOffers(
      {
        ...
        pictureCandidates: [
          {
            url: 'https://http2.mlstatic.com/D_NQ_NP_2X_111-I.webp',
            source: 'ml_api',
            sourceItemId: 'MLM1',
            pictureId: null,
            isPrimary: true,
          ...
          {
            url: 'https://http2.mlstatic.com/D_NQ_NP_2X_222-I.webp',
            source: 'ml_api',
            sourceItemId: 'MLM1',
            pictureId: null,
            isPrimary: false,
      ...
      },
      {
        ...
        pictureCandidates: [
          ...
          {
            url: 'https://http2.mlstatic.com/D_NQ_NP_2X_333-I.webp',
            source: 'ml_api',
            sourceItemId: 'MLM1',
            pictureId: null,
            isPrimary: false,
